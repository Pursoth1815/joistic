...
import 'package:joistic/core/widgets/no_internet.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomButton(
                      ...
                      width: Get.width * 0.75,
                      color: AppColors.blue,
                      onPressed: () async => connectivityController.isConnected.value
                          ? loginController.login(loginController.email.text, loginController.password.text)
                          : Get.snackbar("Warning!", AppStrings.no_internet_image),
                    ),
                    Spacer(
                      flex: 3,
                    ),
